...
#3
print(f"A(z) {a:.2f}cm, {b:.2f}cm, {c:.2f}cm oldalhosszúságú háromszög kerülete: {K:.2f}cm")
print(f"A(z) {a:.2f}cm, {b:.2f}cm, {c:.2f}cm oldalhosszúságú háromszög területe: {T:.2f}cm^2")